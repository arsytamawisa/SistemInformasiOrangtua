		...
		<?php foreach ( $kelas as $key => $value ): ?>
			<tr>
				...
				<td>
					...
					<a href="<?= site_url("admin/presensi/tambah/$value[id_kelas]") ?>" title="Tambah">
						<span class="iconify icon:fa-solid:plus-circle"></span>
					</a>&nbsp;
					<?php endif ?>

					<?php if (hitung_siswa($value['id_kelas']) !== 0): ?>
					<a href="<?= site_url("admin/presensi/detail/$value[id_kelas]") ?>" title="Detail"> 
